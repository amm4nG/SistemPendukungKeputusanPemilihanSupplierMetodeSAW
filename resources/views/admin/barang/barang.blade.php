...
@section('content')
    ...
    <div id="wrapper">
        ...
        {{-- sidebar menu --}}
        @include('admin.menu-sidebar.menu-sidebar-barang')
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><span
                                        class="text-capitalize">{{ Auth::user()->username }}</span></span>
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('storage/images/image-profile-default.jpg') }}">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    {{-- table barang --}}
                                    @include('admin.barang.table-barang')
                                </div>
                            </div>
                        </div>
                    </div>
